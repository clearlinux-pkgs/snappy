...
Source0  : https://github.com/google/snappy/archive/1.2.0/snappy-1.2.0.tar.gz
...
%prep
%setup -q -n snappy-1.2.0
cd %{_builddir}/snappy-1.2.0
%patch -P 1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1712330614
mkdir -p clr-build
pushd clr-build

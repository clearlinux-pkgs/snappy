...
Version  : 1.1.8
Release  : 22
URL      : https://github.com/google/snappy/archive/1.1.8/snappy-1.1.8.tar.gz
Source0  : https://github.com/google/snappy/archive/1.1.8/snappy-1.1.8.tar.gz
...
%prep
%setup -q -n snappy-1.1.8
cd %{_builddir}/snappy-1.1.8
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1579197648
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/snappy-1.1.8/COPYING %{buildroot}/usr/share/package-licenses/snappy/c3af063092a3cd8c31335607ba466fe91898bd4e
pushd clr-build
%make_install
popd
